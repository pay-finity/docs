...
| 60117      | incorrect trackerID                                  | 400             |
| 60118      | wrong trackerID/orderID                              | 400             |
...
- **trackerID** - уникальный идентификатор транзакции в нашей стороне (обязательный, если не указан clientID)
- **clientID** - уникальный идентификатор транзакции в вашей системе (обязательный, если не указан trackerID)
- **⚠️ ВАЖНО** - указываться может только один из ID транзакции
...
- **updatedTime** - время обновления транзакции
- **amount** - фактическая сумма транзакции в нативной валюте
- **requestAmount** - запрошенная сумма транзакции в нативной валюте
